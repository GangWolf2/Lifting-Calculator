...
import { MaxPercentagesResultsPage } from '../pages/maxpercentages-results/maxpercentages-results';

//7/3/2019: possibly delete MaxPercentageResults(both) because only should be acessible through already established tabs
